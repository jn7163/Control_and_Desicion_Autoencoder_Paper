...
通过实验结果可以计算出不作任何特征变换的BP神经网络，神经元网络激活函数使用Sigmoid函数，节点大小为24-100-8，,对于预测有故障的正确率为
46.7\%，无故障的正确率为69.6
...
~\\\\\\测试\TeX \LaTeX \LaTeXe \cite{srivastava2014dropout, srivastava214dropout, srivastava2014ropout}\cite{srivastava2014ropout}\cite{srivastava214dropout}
